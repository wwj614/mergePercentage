...
class cumulativeCurveTest(unittest.TestCase):
    ...
    def test_curveFromBin(self):
        ...
        self.assertTrue(CumulativeCurve.almostEqual(c,self.c0))
    ...
    def test_curveFromBinCount1(self):
        ...
        self.assertTrue(CumulativeCurve.almostEqual(c,self.c1))
    ...
    def test_merge(self):
        ...
        self.assertTrue(CumulativeCurve.almostEqual(c,self.c2))
           
        v=list(v01+v11+v21)
        v.sort()
        c0=CumulativeCurve.curveFromBin(v,self.pb)
        print("hash: real {0} estimate {1}".format(hash(c),hash(c0)))
        print("curve:\nreal:\n{0}\nestimate:\n{1}".format(c,c0))
